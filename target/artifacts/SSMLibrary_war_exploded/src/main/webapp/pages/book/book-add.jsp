	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/books/findAll">图书管理</a></li>
				<li class="active">产品表单</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/books/saveBook"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="name"
								placeholder="图书名字" value="">
						</div>
						<div class="col-md-2 title">图书作者</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="writer"
								placeholder="图书作者" value="">
						</div>
						<div class="col-md-2 title">图书类别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="type"
								placeholder="图书类别" value="">
						</div>
